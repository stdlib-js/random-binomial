...
interface RandomFunction extends PRNG {
	/**
	* Returns an ndarray containing pseudorandom numbers drawn from a binomial distribution.
	*
	...
	*/
	<T extends typedndarray<number>, U extends typedndarray<number>>( shape: Shape, n: number | T, p: number | U, options?: Options ): RandomArray;

	/**
	* Fills an ndarray with pseudorandom numbers drawn from a binomial distribution.
	*
	* @param n - number of trials
	* @param p - success probability
	...
	* @returns output ndarray
	*/
	assign<T extends typedndarray<number>, U extends typedndarray<number>, V extends typedndarray<number>>( n: number | T, p: number | U, out: V ): V;
}
...
interface Random extends PRNG {
	...
	*/
	...
	/**
	* Returns a function for creating ndarrays containing pseudorandom numbers drawn from a binomial distribution.
	*
	* @param options - function options
